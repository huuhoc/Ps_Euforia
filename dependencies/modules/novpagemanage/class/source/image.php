...
if( !class_exists("Megaimage") ){
class Megaimage extends Megasource {
	public $type = 'image';
	public function renderForm($data){
		...
		public function getDataSource( $config ){
			...
			$data['subtitle'] = isset($config['subtitle_'.$id_language])?($config['subtitle_'.$id_language]): "";
			...
			$data['link_image'] = isset($config['link_image']) ? ($config['link_image']) : '#';
