...
if( !class_exists("Megasocial_link") ){
class Megasocial_link extends Megasource {
	public $type = 'social_link';
	public function renderForm($data){
			...
			$this->fields_form[0]['form'] = array(
				'tinymce' => true,
	            'legend' => array(
	                'title' => $this->l('Social Form.'),
					'desc' => $this->l('Please add link social in settings Vinova Themes Configurator'),
	            ),
	            'input' => array(
					array(
	                    'type' => 'text',
