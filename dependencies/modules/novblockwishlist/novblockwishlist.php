...
class NovBlockWishList extends Module
{
	...
	public function hookDisplayProductListFunctionalButtons($params)
	{
		...
		return $this->display(__FILE__, 'novblockwishlist_button.tpl');
	}

	public function hookHeader($params)
	{
		
		$this->context->controller->addCSS(($this->_path).'novblockwishlist.css', 'all');
		...
		Media::addJsDefL('loggin_required', $this->l('You must be logged in to manage your wishlist.', null, true, false));
		Media::addJsDefL('added_to_wishlist', $this->l('The product was successfully added to your wishlist.', null, true, false));			
		...
		return $this->display(__FILE__, 'novblockwishlist_top.tpl');
	}
	...
	public function hookRightColumn($params)
	{
		...
		return ($this->display(__FILE__, 'novblockwishlist.tpl'));
	}
	...
	public function hookProductActions($params)
	{
		...
		return ($this->display(__FILE__, 'novblockwishlist-extra.tpl'));
	}
