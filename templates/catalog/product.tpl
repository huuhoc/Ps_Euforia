...
{block name='content'}
  ...
  <section id="main" itemscope itemtype="https://schema.org/Product">
    ...
    <div class="row">
        ...
        {else}
        <div class="col col-lg-4-9 col-md-4-9 col-xs-12 mt-xs-20">
        {/if}
        ...
        <div class="col col-lg-6 col-md-6 col-xs-12">
          <h1 class="detail-product-name" itemprop="name">{block name='page_title'}{$product.name}{/block}</h1>
        {else}
        <div class="col col-lg-5-9 col-md-5-9 col-xs-12 mt-xs-20">
        {/if}
    ...
    {block name='product_accessories'}
      {if $accessories}
        <section class="relate-product product-accessories clearfix">
          <h3 class="h5 title_block text-uppercase">{l s='Relate products' d='Shop.Theme.Catalog'}<span class="sub_title">{l s='Hand-picked arrivals from the best designer' d='Shop.Theme.Catalog'}</span></h3>
          <div 
