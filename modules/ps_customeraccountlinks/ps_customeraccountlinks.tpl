...
<div id="_desktop_user_info">
    <div class="user-info--warpper dropdown js-dropdown">
        <a href="{$urls.pages.my_account}" rel="nofollow" class="expand-more" data-toggle="dropdown" aria-expanded="false">
            <i class="zmdi zmdi-account"></i>
            <span>{l s='My Account' d='Modules.Customeraccount'}</span>
        </a>
        <div class="account-list dropdown-menu" id="_desktop_account_list">
		    <div class="account-list-content">
		      ...
		      <div class="link_wishlist">
		        <a href="{$link->getModuleLink('novblockwishlist', 'mywishlist', array(), true)|escape:'html':'UTF-8'}" title="{l s='My Wishlists' d='Modules.Novblockwishlist'}">
